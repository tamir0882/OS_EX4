...
* Parameters:
* int argc - same argc as given to main thread, used for validation check.
* char** argv - same argc as given to main thread, 
* char mission_file_name[_MAX_PATH]
* char priority_file_name[_MAX_PATH]
* HANDLE* p_h_priority_file
* int* p_number_of_missions
* int* p_number_of_threads
